...
import com.example.tracker_domain.use_cases.CalculateMealNutrients
...
class CalculateMealNutrientsTest {
    ...
    // gets called on each test that happens to have a fresh environment to do the test
    @Before
    fun setup() {
        // our own mocked preferences
        val preferences = mockk<Preferences>(relaxed = true)
        // the value to return when that fun is called
    ...
    fun `Calories for breakfast properly calculated`() {
        ...
        // compares the one of the useCase from the original one
