...
// receives the preferences injection from the di construction of all viewModels
class CalculateMealNutrients(
    private val preferences: Preferences
) {

    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        // creates a map that separates the different types of food
        // and converts it to a class that we did
        ...
        // gathers all the data from all the mao
        ...
        // gets the needed calories per day
        val calorieGoal = dailyCaloryRequirement(userInfo)

        //the divisions are to transform the protein, carb or fat to calorie
        // 1 carb = 4 calories
    ...
    // holder classes for the use case
